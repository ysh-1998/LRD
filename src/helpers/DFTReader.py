...
class DFTReader(KGReader):
    ...
    def __init__(self, args):
        ...
        if "latent_relation_num" in args:
            self.interval_file = os.path.join(self.prefix, self.dataset, f'interval_{args.latent_relation_num}.pkl')
        else:
...
if __name__ == '__main__':
    ...
    if "latent_relation_num" in args:
        corpus_path = os.path.join(args.path, args.dataset, f'DFTReader_{args.latent_relation_num}.pkl')
    else:
